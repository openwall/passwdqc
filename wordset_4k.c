...
const char _passwdqc_wordset_4k[][WORDSET_4K_LENGTH_MAX] = {
	...
	"web",
	"zoo",
	"ant", /* more previously missed common English words */
	"bee",
	"cookie",
	"cop",
	"cops",
	...
	"Arab",
	"Asian",
	"Aaron", /* common short names that weren't in original list */
	"Alan",
	"Alexis", /* and Alex */
	"Allen",
	"Alyssa",
	...
	"Emma",
	"Ethan",
	"Eva", /* we also have Eve */
	"Gary",
	"Gregor", /* and Greg */
	"Hannah", /* and Hanna, Anna */
	"Harley",
	"Jackie", /* we also have Jack */
	"Jake",
	"Jamie",
	"Jane",
	"Jason",
